    ...
    <header className="max-w-7xl mx-auto px-8 md:px-8 flex items-center justify-between h-24">
      ...
      <nav className="flex gap-6 items-center">
        ...
        <ul
          ...
          className={`md:flex md:items-center z-[1] text-center md:z-auto md:static absolute w-full left-0 md:w-auto md:py-0 space-x-4 transition-all ease-in-out duration-500 ${
            mobileMenu ? "top-[95px]" : "top-[-400px]"
          }`}
        >
