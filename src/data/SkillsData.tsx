    ...
    },
    {
        ...
        icons: [
            ...
            },
            {
                ...
                description: "Tailwind CSS is a utility-first and highly customizable CSS framework for rapidly building custom user interfaces."
            },
        ],
    },
    {
        ...
        icons: [
            {
                ...
                description: "Git is a software for tracking changes in any set of files, usually used for coordinating work among programmers collaboratively developing source code during software development."
            },
            {
                name: "GitHub",
        ...
        icons: [
            {
                name: "C++",
                logo: <Icons icons="C++" />,
                description: "C++ is a general-purpose programming language as an extension of the C programming language, or 'C with Classes'."
            },
            {
                name: "Kotlin",
